...
for word in text_to_check_list:
    # if the word is not presented in the dictionary, no mistake anyway
    if word.lower() in accents_dict:
        # if there is no such accent in the dictionary - it's a mistake
        mistakes_count += int(word not in accents_dict[word.lower()])

    elif word.isupper() or word.islower():
        # mistake if all letter are in lower or upper case
        mistakes_count += 1
